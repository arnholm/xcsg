...
#ifndef XPROJECTION2D_H
#define XPROJECTION2D_H

#include "xshape2d.h"
#include "xsolid.h"

class xprojection2d : public xshape2d {
public:
   xprojection2d();
   xprojection2d(const cf_xmlNode& node);
   virtual ~xprojection2d();
