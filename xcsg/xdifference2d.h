...
#ifndef XDIFFERENCE2D_H
#define XDIFFERENCE2D_H

#include "xshape2d.h"
#include <set>

class xdifference2d : public xshape2d {
public:
   xdifference2d();
   xdifference2d(const cf_xmlNode& node);
   virtual ~xdifference2d();
...
private:
   ...
   std::unordered_set<std::shared_ptr<xshape2d>> m_excl;
};
